...
This is an FFT up to 8192 elements (LMM=8K*4byte*2=64KB). By expanding to
empty slot of IMAX2,  you can get larger capacity and higher performance.
...
This is a pipelined FFT up to 4096 elements (LMM=4K*4byte*2*2=64KB).
Intermediate LMMs are used as double buffers.
...
This is a pipelined merge sort up to 4096 elements (LMM=4K*8byte*2=64KB).
Intermediate LMMs are used as double buffers.  The size of each element is
8 bytes.  Upper word is compared for sorting, and lower word is for any
value such as pointer and property.
